                ...
                $form->addItem(
                    (new Row())->addCol(
                        (new Col('col-md-3'))->addItem(
                            ...
                            new Cover('封面', 'cover', $category['cover'], $router->build('/ebcms/admin/upload')),
                        ...
                        (new Col('col-md-9'))->addItem(
                            ...
                            new Summernote('频道介绍', 'content', $category['content'], $router->build('/ebcms/admin/upload'))
                        )
                    )
                );
                return $form;
                ...
                $form->addItem(
                    (new Row())->addCol(
                        ...
                        (new Col('col-md-9'))->addItem(
                            (new Input('标题', 'title', $category['title']))->set('help', '一般不超过20个字符')->set('required', 1),
                            (new Input('名称', 'name', $category['name']))->set('help', '一般用英文')->set('required', 1),
                            new Summernote('栏目介绍', 'content', $category['content'], $router->build('/ebcms/admin/upload')),
                ...
                $form->addItem(
                    (new Row())->addCol(
                        ...
                        (new Col('col-md-9'))->addItem(
                            (new Input('标题', 'title', $category['title']))->set('help', '一般不超过20个字符')->set('required', 1),
                            (new Input('名称', 'name', $category['name']))->set('help', '一般用英文')->set('required', 1),
                            new Summernote('页面内容', 'content', $category['content'], $router->build('/ebcms/admin/upload'))
                        )
                    )
                );
                return $form;
