                ...
                $form->addItem(
                    (new Row())->addCol(
                        ...
                        (new Col('col-md-9'))->addItem(
                            ...
                            new Summernote('频道介绍', 'content', '', $router->build('/ebcms/admin/upload'))
                        )
                    )
                );
                return $form;
                ...
                $form->addItem(
                    (new Row())->addCol(
                        ...
                        (new Col('col-md-9'))->addItem(
                            (new Input('标题', 'title'))->set('help', '一般不超过20个字符')->set('attr.required', 1),
                            (new Input('名称', 'name'))->set('help', '一般用英文')->set('attr.required', 1),
                            new Summernote('栏目介绍', 'content', '', $router->build('/ebcms/admin/upload')),
                ...
                $form->addItem(
                    (new Row())->addCol(
                        ...
                        (new Col('col-md-9'))->addItem(
                            (new Input('标题', 'title'))->set('help', '一般不超过20个字符')->set('attr.required', 1),
                            (new Input('名称', 'name'))->set('help', '一般用英文')->set('attr.required', 1),
                            new Summernote('页面内容', 'content', '', $router->build('/ebcms/admin/upload'))
                        )
                    )
                );
                return $form;
